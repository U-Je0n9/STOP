...
#SBATCH -o /data/wjddb1025/grad_proj/out_files/%j_%x.out
#SBATCH -e /data/wjddb1025/grad_proj/out_files/%j_%x.err
...
cd /data/wjddb1025/grad_proj/CVPR2025-STOP

source /data/wjddb1025/anaconda3/etc/profile.d/conda.sh
conda activate STOP
...
pretrained_dir=/data/wjddb1025/grad_proj/CVPR2025-STOP/models/pretrained
